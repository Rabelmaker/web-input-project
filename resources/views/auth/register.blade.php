...
<!-- Mirrored from laravelui.spruko.com/spruha/signup by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 May 2024 07:59:12 GMT -->
...
<head>
    ...
    <!-- APP SCSS -->
    <link rel="preload" as="style" href="{{asset('theme/spruha')}}/build/assets/app-58d9b917.css" /><link rel="stylesheet" href="{{asset('theme/spruha')}}/build/assets/app-58d9b917.css" />

    <!-- APP CSS -->
    <link rel="preload" as="style" href="{{asset('theme/spruha')}}/build/assets/app-e6039df9.css" /><link rel="stylesheet" href="{{asset('theme/spruha')}}/build/assets/app-e6039df9.css" />
                ...
                <div class="predefined_styles">
                    <div class="swichermainleft text-center">
                        <div class="p-3 d-grid gap-2">
                            <a href="index-2.html" class="btn btn-primary rounded-10 mt-0" target="_blank">View Demo</a>
                            <a href="https://themeforest.net/item/spruha-laravel-admin-dashboard-template/29818213"
                               class="rounded-10 btn btn-secondary" target="_blank">Buy Now</a>
                            <a href="https://1.envato.market/MGEaN"
                               class="rounded-10 btn btn-info" target="_blank">Our Portfolio</a>
                        </div>
                    </div>
                                ...
                                <div class="switch-toggle d-flex mt-2">
                                    ...
                                    <div class="">
                                        <input class="wd-30 ht-30 input-color-picker color-primary-light"
                                               value="#6259ca" id="colorID" type="color"
                                ...
                                <div class="switch-toggle d-flex mt-2">
                                    ...
                                    <div class="">
                                        <input class="wd-30 ht-30 input-dark-color-picker color-primary-dark"
                                               value="#6259ca" id="darkPrimaryColorID"
                ...
                <div class="row row-sm">
                    <div class="col-lg-6 col-xl-5 d-none d-lg-block text-center bg-primary details">
                        <div class="mt-5 pt-5 p-2 pos-absolute">
                            <img src="{{asset('theme/spruha')}}/build/assets/img/brand/logo-light.png" class="header-brand-img mb-4" alt="logo">
                            <div class="clearfix"></div>
                            <img src="{{asset('theme/spruha')}}/build/assets/img/svgs/user.svg" class="ht-100 mb-0" alt="user">
                        ...
                        <div class="main-container container-fluid">
                            <div class="row row-sm">
                                <div class="card-body mt-2 mb-2">
                                    <img src="{{asset('theme/spruha')}}/build/assets/img/brand/logo-light.png" class="d-lg-none header-brand-img text-start float-start mb-4 error-logo-light" alt="logo">
                                    <img src="{{asset('theme/spruha')}}/build/assets/img/brand/logo.png" class=" d-lg-none header-brand-img text-start float-start mb-4 error-logo" alt="logo">
                                    <div class="clearfix"></div>
                                    ...
                                    <form>
                                        ...
                                        <a href="index.html" class="btn btn-main-primary btn-block text-white">Create Account</a>
                                    </form>
...
<!-- THEMECOLORs JS -->
<link rel="modulepreload" href="{{asset('theme/spruha')}}/build/assets/themeColors-71fc6433.js" /><link rel="modulepreload" href="{{asset('theme/spruha')}}/build/assets/apexcharts.common-ba7e62a5.js" /><script type="module" src="{{asset('theme/spruha')}}/build/assets/themeColors-71fc6433.js"></script>

<!-- APP JS -->
<link rel="modulepreload" href="{{asset('theme/spruha')}}/build/assets/app-53348e21.js" /><script type="module" src="{{asset('theme/spruha')}}/build/assets/app-53348e21.js"></script>

<!-- SWITCHER JS -->
<link rel="modulepreload" href="{{asset('theme/spruha')}}/build/assets/switcher-4de6c754.js" /><script type="module" src="{{asset('theme/spruha')}}/build/assets/switcher-4de6c754.js"></script>
